...
bracketPram3.BracketName="HK.Casing.Wall.Fore.DL01.Deck.DP"
bracketPram3.MaterialName="SS400"
bracketPram3.BaseElement=profile7[0]
...
bracketPram3.Surfaces1=[profile6[0]+",FL"]
bracketPram3.RevSf1=False
bracketPram3.Surfaces2=[profile7[0]+",FL"]
...
bracketPram4.Surfaces1=[profile1[0]+",FL"]
...
bracketPram5.BracketName="HK.Casing.Wall.Side.FR13.Deck.DP"
bracketPram5.MaterialName="SS400"
bracketPram5.BaseElement=profile15[0]
...
bracketPram5.Surfaces1=[profile14[0]+",FL"]
bracketPram5.RevSf1=False
bracketPram5.Surfaces2=[profile15[0]+",FL"]
...
bracketPram6.BracketName="HK.Casing.Wall.Side.FR07.Deck.CP"
bracketPram6.MaterialName="SS400"
bracketPram6.BaseElement=profile8[0]
...
bracketPram6.Surfaces2=[profile8[0]+",FL"]
...
# ブラケットセクション（bracketPram7 から始まり、最後のSetElementColorで終わる）
bracketPram7 = part.CreateBracketParam()
bracketPram7.DefinitionType=1
bracketPram7.BracketName="HK.Casing.Wall.Side.FR11.Deck.CP"
...
bracketPram8.BaseElement=profile17[0]
...
bracketPram8.Surfaces1=[profile16[0]+",FL"]
...
bracketPram9.Surfaces1=[profile1[0]+",FL"]
...
bracketPram11.Surfaces1=[profile27[0]+",FL"]
